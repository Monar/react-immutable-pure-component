...
describe('updateOnStates and updateOnProps', () => {
  ...
  it('are both default', () => {
    ...
    expect(Component.shouldComponentUpdate({p: 1, x: 1}, { s: 1, x: 2 })).toBe(false);
    expect(Component.shouldComponentUpdate({p: 1}, { s: 1 })).toBe(true);
    expect(Component.shouldComponentUpdate({p: 1, x: 1}, { s: 2 })).toBe(true);
    expect(Component.shouldComponentUpdate({p: 2}, { s: 1, x: 2 })).toBe(true);
  });
  ...
  it('are both empty', () => {
    ...
    expect(Component.shouldComponentUpdate({p: 1, x: 1}, { s: 1, x: 2 })).toBe(false);
    expect(Component.shouldComponentUpdate({p: 1}, { s: 1 })).toBe(false);
    expect(Component.shouldComponentUpdate({p: 1, x: 1}, { s: 2 })).toBe(false);
    expect(Component.shouldComponentUpdate({p: 2}, { s: 1, x: 2 })).toBe(false);
  });
});
