...
function (_React$Component) {
  ...
  _createClass(ImmutablePureComponent, [{
    ...
    value: function shouldComponentUpdate(nextProps) {
      ...
      var checkProps = createChecker(props, nextProps, 'updateOnProps');
      var checkStates = createChecker(state, nextState, 'updateOnStates');
...
function createChecker(prev, next, checkName) {
  return function (name) {
    ...
    return immutable.is(immutable.getIn(next, name), immutable.getIn(prev, name));
  };
}
